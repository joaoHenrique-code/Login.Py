...
l_nome = Label(frame_cima, width=275, text="", height=1, anchor=NW, font=('Ivy 1'), bg=co2)
...
def nova_janela():
    ...
    l_linha = Label(frame_cima, width=275, text="", height=1, anchor=NW, font=('Ivy 1'), bg=co1, fg=co2)
...
l_nome = Label(frame_baixo, text="Nome * ", height=1, anchor=NW, font=('Ivy 10'), bg=co1, fg=co4)
